  ...
  Widget build(BuildContext context) => PageContent(
    ...
    children: [
      FeaturePlaceholder(
        ...
        description: 'Try a short assessment in five subjects, see your score and review your answers. Results stay only in memory; progress tracking is coming later.',
